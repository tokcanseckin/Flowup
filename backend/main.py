...
_INITIAL_LOCALIZATIONS: list[dict] = [
    ...
    {"key": "subscriptions.masterLanguageHeading","en": "It lets you focus on fun & you get what you need instantly", "tr": "Eğlenceye odaklanmanızı sağlar ve ihtiyacınız olanı anında almanızı sağlar", "ru": "Сосредоточьтесь на удовольствии и получайте то, что нужно мгновенно", "es": "Te permite concentrarte en la diversión y obtener lo que necesitas al instante", "pt": "Permite que você se concentre na diversão e obtenha o que precisa instantaneamente", "de": "Konzentriere dich auf den Spaß und erhalte sofort, was du brauchst"},
