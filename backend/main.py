...
_INITIAL_LOCALIZATIONS: list[dict] = [
    ...
    {"key": "subscriptions.masterLanguageHeading","en": "Unlock unlimited interactive lyrics", "tr": "Sınırsız etkileşimli şarkı sözlerinin kilidini aç", "ru": "Разблокируйте неограниченные интерактивные тексты", "es": "Desbloquea letras interactivas ilimitadas", "pt": "Desbloqueie letras interativas ilimitadas", "de": "Schalte unbegrenzte interaktive Songtexte frei"},
