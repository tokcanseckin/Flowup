  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden" style={{ background: '#050608' }}>
      ...
      <div className="flex flex-1 min-h-0">
        <div className="flex flex-1 min-h-0 max-w-[1120px] w-full mx-auto">
        {/* Left sidebar */}
        ...
        {/* Content */}
        <main className="flex-1 overflow-y-auto px-6 py-6 flex flex-col" style={{ background: '#050608' }}>
...
function PlayerView({
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden" style={{ background: '#050608', transition: 'background 1.2s ease' }}>
      ...
      <main className="flex-1 min-h-0 p-4 max-w-[1120px] mx-auto w-full flex flex-col gap-3">
