          ...
          {user && user.subscription_tier === 'free' && activePlaylistId !== null ? (
            <>
              ...
              {songs.slice(0, 2).length > 0 && (
                <>
                  <div className="rounded-lg px-4 h-8 mb-2 mt-1 flex items-center" style={{ background: '#006D36' }}>
              ...
              {songs.slice(2).length > 0 && (
                <>
                  <div className="rounded-lg px-4 h-8 mb-2 mt-4 flex items-center justify-between bg-indigo-600">
                    <span className="text-xs font-semibold uppercase tracking-wider text-white">
                      Premium List
                    </span>
                    <button
